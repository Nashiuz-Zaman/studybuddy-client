  ...
  return (
    <div>
      ...
      <div
        ...
        } rounded-default bg-primaryLight p-10 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[60] shadow-lg duration-200`}
      >
        <button className="block w-max ml-auto mb-4" onClick={closeModal}>
          <AiOutlineClose className="text-white text-3xl" />
        </button>
        <IoCheckmarkCircle className="text-white text-5xl block mx-auto mb-8" />
        <p className="text-white text-3xl">Assignment Created Successfully</p>
      </div>
    </div>
  );
};
